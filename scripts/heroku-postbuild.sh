...
vagov_apps_dir=${vagov_content_dir}/node_modules/vagov-apps
...
npm --prefix node_modules/vagov-apps run build -- --entry static-pages --brand-consolidation-enabled --content-directory=${vagov_content_dir}/pages
