...
title: VA Funding Fees and Loan Closing Costs
heading: VA funding fees and loan closing costs
display_title: VA Funding Fee
description: Learn about the VA funding fee and other closing costs you may need to pay on your VA-backed or VA direct home loan. The VA funding fee is a one-time payment that the Veteran or survivor pays on a VA-backed or VA direct home loan.
...
Review the VA funding fee rate charts below to determine the amount you’ll have to pay. Down payment and VA funding fee amounts expressed as a percentage of total loan amount.
...
<h4>Rates for Veterans with active-duty service</h4>
...
<strong>Note:</strong> If you used a VA-backed or VA direct home loan to purchase a manufactured home, you only need to pay the first-time use funding fee.
...
<h3>Cash-out refinancing loans</h3>

<h4>Rates for Veterans with active-duty service</h4>

| If this is your first time using the VA home loan program  | If you've used the VA home loan program before |
| --- | --- | 
| 2.15% | 3.3% |
...
**Note:** The VA funding fee rates for these loans don't change depending on your military category or whether you've used the VA home loan program in the past.
...
<strong>You (the buyer) usually pay for these closing costs:</strong>
- VA funding fee
...
<strong>The seller usually pays for these closing costs (sometimes called "seller's concessions"):</strong>
...
<strong>Both the buyer (you) and the seller can pay these closing costs:</strong> 
- VA appraisal
- Credit report
