...
## How can I learn more about participating in this research?
...
### Why should I consider participating in COVID-19 research?
...
[TBD: Anything specific we can say about the studies we're doing that would encourage interpeople more interested?]

### What should I expect if I'm eligible for a study?
...
## Answers to more questions about research at VA

<ul class="usa-accordion">
<li>
<button class="usa-button-unstyled usa-accordion-button" aria-controls="diverse"Why is VA encouraging a diverse range of people to join this research?</button>
...
- Need different dosages of a drug to get the intended result
- Experience different side effects from a drug

We're working to find the best ways to prevent and treat COVID-19 in all people. So to do that, we must include people of all ages (over 18 years old), gender identities, races, and ethnicities.
...
This is a good question, especially because the history of clinical research in the U.S. includes serious issues in the past. Today, strong laws are in place to protect the safety of every person who joins a study.  
To reach more about changes to U.S. laws on clinical trial safety, visit the CDC website.
...
<li>
<button class="usa-button-unstyled usa-accordion-button" aria-controls="questions">What if I have questions about the study?</button>
